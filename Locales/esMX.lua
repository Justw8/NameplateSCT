...
--L["Remove Icon borders"] = "Remove Icon borders"
--L["Zoom a bit into the icon to remove default blizzard border"] = "Zoom a bit into the icon to remove default blizzard border"
