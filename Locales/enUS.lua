...
L["Fountain"] = true
L["Fireworks"] = true
L["Fireworks Radius"] = true
L["Fireworks Settings"] = true
L["Fireworks Duration"] = true
L["Duration of the fireworks animation"] = true
L["Start radius for fireworks animation"] = true
