...
L["Unfortunately Blizzard has not added a SCT API in Midnight, until they do this addon will not have any functionality."] = "不幸的是，暴雪在《至暗之夜》版本中仍未添加SCT API。在实现此功能前，该插件将无法正常运行。"
