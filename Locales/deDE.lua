...
L["Remove Icon borders"] = "Pictogramgrenzen verwijderen"
L["Zoom a bit into the icon to remove default blizzard border"] = "Zoom een beetje in het pictogram om de standaard sneeuwstormrand te verwijderen"
