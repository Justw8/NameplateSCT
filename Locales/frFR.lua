...
L["Remove Icon borders"] = "Supprimer les bordures de l’icône"
L["Zoom a bit into the icon to remove default blizzard border"] = "Zoom un peu sur l’icône pour supprimer la bordure de blizzard par défaut"
